...
class waf_regional_client_type(BaseClient):
    def associate_web_acl(self, WebACLId: str, ResourceArn: str): ...
    ...
    def disassociate_web_acl(self, ResourceArn: str): ...
    ...
    def get_web_acl_for_resource(self, ResourceArn: str): ...
    ...
    def list_resources_for_web_acl(self, WebACLId: str, ResourceType: str = None): ...
